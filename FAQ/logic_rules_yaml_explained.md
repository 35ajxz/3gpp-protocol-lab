...
```text
+--------------------------------------------------------------------------------------------------+
|                                  logic_rules.yaml 产生过程                                       |
+--------------------------------------------------------------------------------------------------+
| 1. 真实规范输入                                                                                  |
|    corpus/real/raw/*.md                                                                          |
|    corpus/real/slices/5.3.3-*.md / 5.3.13-*.md                                                   |
+--------------------------------------------------------------------------------------------------+
                                          |
                                          v
+--------------------------------------------------------------------------------------------------+
...
|    使用 Codex + schema，从规范切片中抽取状态、事件、定时器、变量、动作、引用                     |
+--------------------------------------------------------------------------------------------------+
                                          |
                                          v
+--------------------------------------------------------------------------------------------------+
...
|    检查结构完整性、步骤顺序、消息/定时器/变量覆盖、条款引用格式                                   |
+--------------------------------------------------------------------------------------------------+
                                          |
                                          v
+--------------------------------------------------------------------------------------------------+
| 5. 人工规则固化                                                                                  |
|    constraints/logic_rules.yaml                                                                  |
|    基于 EFSM 和安全研究关注点，提炼 initial_state / scenarios / invariants / perturbations       |
+--------------------------------------------------------------------------------------------------+
                                          |
                                          v
+--------------------------------------------------------------------------------------------------+
...
|    scripts/logic_fuzz.py                                                                         |
|    scripts/run_logic_campaign.py                                                                 |
|    将规则变成批量测试序列，并输出 findings / traces / summary                                    |
+--------------------------------------------------------------------------------------------------+
```
